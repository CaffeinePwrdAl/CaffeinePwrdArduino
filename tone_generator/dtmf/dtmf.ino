...
/*
 * https://forum.arduino.cc/index.php?topic=104658.0
 * 
...
const Note tune[] = {
  ...
  { MAKE_NOTE(NOTE_FS, 1), DO_REST,                     16 },
  { MAKE_NOTE(NOTE_A,  1), DO_REST,                     8 },
  { MAKE_NOTE(NOTE_B,  1), DO_REST,                     16 },
  { DO_REST,               DO_REST,                     8},
  
  { MAKE_NOTE(NOTE_FS, 1), DO_REST,                     16 },
  { MAKE_NOTE(NOTE_B,  1), DO_REST,                     16 },
  { DO_REST,               DO_REST,                     16},
  { MAKE_NOTE(NOTE_CS, 2), DO_REST,                     8 },
  
  { MAKE_NOTE(NOTE_FS, 1), DO_REST,                     16 },
  { MAKE_NOTE(NOTE_CS, 2), DO_REST,                     8 },
  { MAKE_NOTE(NOTE_D,  2), DO_REST,                     16 },
  
  { DO_REST,               DO_REST,                     16},
  { MAKE_NOTE(NOTE_FS, 1), DO_REST,                     8 },
  { MAKE_NOTE(NOTE_CS, 2), DO_REST,                     8 },
  
  { MAKE_NOTE(NOTE_B,  1), DO_REST,                     16 },
  { MAKE_NOTE(NOTE_A,  1), DO_REST,                     16 },
  { MAKE_NOTE(NOTE_FS, 1), DO_REST,                     16 },

  { MAKE_NOTE(NOTE_E,  1), MAKE_NOTE(NOTE_CS, 2),       8 | DOTTED_NOTE },//C
  { MAKE_NOTE(NOTE_FS, 1), MAKE_NOTE(NOTE_D,  2),       8 },

  { MAKE_NOTE(NOTE_D,  2), DO_REST,                     16 }, 
  { MAKE_NOTE(NOTE_CS, 2), DO_REST,                     16 },
  { MAKE_NOTE(NOTE_B,  1), DO_REST,                     16 },

  { MAKE_NOTE(NOTE_FS, 1), DO_REST,                     16 },
  { MAKE_NOTE(NOTE_E,  1), MAKE_NOTE(NOTE_A,  1),       8 },
  { MAKE_NOTE(NOTE_FS, 1), MAKE_NOTE(NOTE_B,  1),       16 },
  { DO_REST,               DO_REST,                     8},
  ...
  { DO_REST,               DO_REST,                     16 },
  { MAKE_NOTE(NOTE_GS, 1), MAKE_NOTE(NOTE_CS, 2),       8 | DOTTED_NOTE},

  { MAKE_NOTE(NOTE_FS, 1), DO_REST,                     16 },
  { MAKE_NOTE(NOTE_GS, 1), MAKE_NOTE(NOTE_CS, 2),       8 },
  { MAKE_NOTE(NOTE_A,  1), MAKE_NOTE(NOTE_D,  2),       16 },

  { DO_REST,               DO_REST,                     16 },
  { MAKE_NOTE(NOTE_FS, 1), DO_REST,                     8 },
  { MAKE_NOTE(NOTE_A,  1), MAKE_NOTE(NOTE_CS, 2),       8 },

  { MAKE_NOTE(NOTE_GS, 1), MAKE_NOTE(NOTE_B,  1),       16 },
  { MAKE_NOTE(NOTE_FS, 1), MAKE_NOTE(NOTE_A,  1),       16 },
  { MAKE_NOTE(NOTE_FS, 1), DO_REST,                     16 },
  
  { MAKE_NOTE(NOTE_E,  1), MAKE_NOTE(NOTE_B,  1),       8 | DOTTED_NOTE },
/*  { MAKE_NOTE(NOTE_A,  1), DO_REST,                     8 },
...
/*
  { MAKE_NOTE(NOTE_FS, 1), MAKE_NOTE(NOTE_CS, 1),       16 },
  { MAKE_NOTE(NOTE_FS, 1), MAKE_NOTE(NOTE_CS, 1),       16 },
  { MAKE_NOTE(NOTE_FS, 1), MAKE_NOTE(NOTE_CS, 1),       16 },
  { MAKE_NOTE(NOTE_FS, 1), MAKE_NOTE(NOTE_CS, 1),       16 },
  ...
  { MAKE_NOTE(NOTE_FS, 1), DO_REST,                     16 },
  { MAKE_NOTE(NOTE_FS, 1), DO_REST,                     16 },
  { MAKE_NOTE(NOTE_G,  1), DO_REST,                     16 },
  { MAKE_NOTE(NOTE_G,  1), DO_REST,                     16 },

  { MAKE_NOTE(NOTE_FS, 1), DO_REST,                     16 },
  { MAKE_NOTE(NOTE_E,  1), DO_REST,                     16 },
  { MAKE_NOTE(NOTE_G,  1), DO_REST,                     16 },
  { MAKE_NOTE(NOTE_G,  1), DO_REST,                     16 },
...
Tone Tone1, Tone2;
const int Tone1Pin = 8;
const int Tone2Pin = 9;
...
void PlayDN3D()
{
  for (uint8_t thisNote = 0; thisNote < numNotesInTune; thisNote++)
  {
    ...
    if (n.freq_a != 0)
    {
      Tone1.play(n.freq_a, ms);
      if (n.freq_b != 0)
      {
        Tone2.play(n.freq_b, ms);
      }
      delay(ms);
    }
    else
...
void setup() {
  Tone1.begin(Tone1Pin);
  Tone2.begin(Tone2Pin);
  PlayDN3D();
  delay(1000);
}
